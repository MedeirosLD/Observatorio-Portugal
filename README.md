...
*Note: Raw source maps (>2.7 GB) and raw Excel results (>290 MB) are excluded from this repository via `.gitignore` to keep the repository lightweight.*

## Deployment

This project is configured for deployment on **GitHub Pages**. Since the application is built entirely with client-side technologies (HTML, CSS, and JavaScript), it runs directly from the repository.

Once published, the visualizer can be accessed at:
`https://<your-username>.github.io/<your-repository-name>/eleicoes.html`
